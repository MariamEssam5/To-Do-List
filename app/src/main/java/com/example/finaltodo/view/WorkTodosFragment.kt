...
class WorkTodosFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_work_todos, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        toDoViewModel.allToDos.observe(viewLifecycleOwner, { todos ->
            todos?.let {
                // Filter tasks based on the "Work" keyword
                val workTodos = it.filter { todo ->
                    todo.title.contains("Work", ignoreCase = true)
                }
                toDoAdapter.setData(workTodos)
            }
        })
